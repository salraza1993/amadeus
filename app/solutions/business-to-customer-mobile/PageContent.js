...
function PageContent({data}) {
  ...
  const sec_1st_data = data?.b2cm1stSections;
  const sec_2nd_data = data?.b2cm2ndSections;
  const sec_3rd_data = data?.b2cm3rdSections;
  const sec_4th_data = data?.b2cm4thSections;
  const sec_5th_data = data?.b2cm5thSections;
  const sec_6th_data = data?.b2cm6thSections;

  const benefitLists = sec_5th_data?.b2cmSec5thList;
  ...
  return <>
      ...
      <div className="container">
        <div className="sub-page-block-1st__container">
          <div className="b2b-block__content"
            ...
            <div dangerouslySetInnerHTML={{ __html: sec_1st_data?.b2cmSec1stContent }}></div>
            <Link
              href={sec_1st_data?.b2cmSec1stButton?.url}
              alt={sec_1st_data?.b2cmSec1stButton?.altText}
              className="btn btn-secondary btn-lg mt-1">
              {sec_1st_data?.b2cmSec1stButton?.title}
            </Link>
          </div>
          <div className="b2b-block__image"
            ...
            <ImageTag
              src={sec_1st_data?.b2cmSec1stImage?.node?.sourceUrl}
              alt={sec_1st_data?.b2cmSec1stImage?.node?.altText} width={'auto'} />
          </div>
        </div>
      </div>
    </section>
          ...
          <div className="row g-4">
            <div className="col-12 col-lg-7 pe-lg-0 d-flex justify-content-center">
              <div className="b2b-block__image" ref={block2nd.imageRef} style={{
                ...
                <ImageTag
                  src={sec_2nd_data?.b2cmSec2ndImage?.node?.sourceUrl}
                  alt={sec_2nd_data?.b2cmSec2ndImage?.node?.altText} />
              </div>
            </div>
            <div className="col-12 col-lg-5 d-flex justify-content-center align-items-center">
              <div className="b2b-block__content" ref={block2nd.contentRef}
                ...
                <div className="text" dangerouslySetInnerHTML={{ __html: sec_2nd_data?.b2cmSec2ndContent }}></div>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="row g-4">
            <div className="col-12 col-lg-5 d-flex justify-content-center align-items-center">
              <div className="b2b-block__content" ref={block3rd.contentRef}
                ...
                <div className="text" dangerouslySetInnerHTML={{ __html: sec_3rd_data?.b2cmSec3rdContent }}></div>
              </div>
            </div>
            <div className="col-12 col-lg-7 ps-lg-0 d-flex justify-content-center">
              <div className="b2b-block__image" ref={block3rd.imageRef} style={{
                ...
                <ImageTag
                  src={sec_3rd_data?.b2cmSec3rdImage?.node?.sourceUrl}
                  alt={sec_3rd_data?.b2cmSec3rdImage?.node?.altText} />
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="row g-4">
            <div className="col-12 col-lg-7 pe-lg-0 d-flex justify-content-center">
              <div className="b2b-block__image" ref={block4th.imageRef} style={{
                ...
                <ImageTag
                  src={sec_4th_data?.b2cmSec4thImage?.node?.sourceUrl}
                  alt={sec_4th_data?.b2cmSec4thImage?.node?.altText} />
              </div>
            </div>
            <div className="col-12 col-lg-5 d-flex justify-content-center align-items-center">
              <div className="b2b-block__content" ref={block4th.contentRef}
                ...
                <div className="text" dangerouslySetInnerHTML={{ __html: sec_4th_data?.b2cmSec4thContent }}></div>
              </div>
            </div>
          </div>
        </div>
    ...
    <section className='sub-page-block sub-page-block-5th'>
      <div className="container">
        <div className="sub-page-block-5th__container">
          <div dangerouslySetInnerHTML={{ __html: sec_5th_data?.b2cmSec5thHeading }}></div>
          <div className="row g-4">
            <div className="col-12 col-lg-5 d-flex justify-content-center">
              <div className="b2b-block__image" ref={block5th.imageRef} style={{
                ...
                <ImageTag
                  src={sec_5th_data?.b2cmSec5thImage?.node?.sourceUrl}
                  alt={sec_5th_data?.b2cmSec5thImage?.node?.altText} />
              </div>
            </div>
                ...
                <ul className="content-list">
                  {
                    benefitLists.map((item, index) => {
                      return <li className="content-list__item" key={index}>
                        <span className="icon">
                          <ImageTag src={item?.b2cmSec5thListIcon?.node?.sourceUrl} alt={item?.b2cmSec5thListIcon?.node?.altText} />
                        </span>
                        <div className="text" dangerouslySetInnerHTML={{ __html: item?.b2cmSec5thListContent }}></div>
                      </li>;
                    })
                  }
                </ul>
    ...
    <section className='sub-page-last-block'>
      <div className="b2b-block__content" ref={block6th.contentRef}
        ...
        <div className="text" dangerouslySetInnerHTML={{ __html: sec_6th_data?.b2cmSec6thContent }}></div>
        <Link
          href={sec_6th_data?.b2cmSec6thButton?.url}
          target={sec_6th_data?.b2cmSec6thButton?.target}
          className='btn btn-light btn-lg'>{sec_6th_data?.b2cmSec6thButton?.title}</Link>
      </div>
      <div className="b2b-block__image">
        <ImageTag
          src={sec_6th_data?.b2cmSec6thImage?.node?.sourceUrl}
          alt={sec_6th_data?.b2cmSec6thImage?.node?.altText} />
      </div>
    </section>
  </>;
}
